<template>
  <div>
    <nav
      id="sidebar_small"
      class="w3-sidebar w3-bar-block w3-card-4 w3-animate-left w3-hide-large w3-large w3-text-white"
      style="display:none; width:85%; background: linear-gradient(#111111, #9c27b0);"
    >
      ...
      <button
        ...
        onclick="$('#contactModal').slideDown(); $('#sidebar_small').slideToggle()"
      >
        <b>
          <i class="fa fa-send"></i> Contact
        </b>
      </button>
      <nuxt-link to="/about" class="w3-bar-item w3-button">
        <b>
    ...
    <button
      ...
      onclick="$('#sidebar_small').slideToggle(); $('#smallArchive').slideUp()"
      style="background:none"
    >
      <i class="fa fa-bars"></i>
    </button>
    <button
      class="w3-bar-item w3-button w3-right w3-text-white w3-large w3-hide-large"
      onclick="$('#smallArchive').slideToggle(); $('#sidebar_small').slideUp()"
      style="background:none"
    >
    ...
    <header class="w3-container w3-purple w3-padding w3-border-gray w3-bottombar">
      <div class="w3-content w3-padding w3-margin-top w3-center">
        ...
        <p class="w3-large">
          ...
          >
            <nuxt-link to="{% url 'personal:about' %}" style="text-decoration: none">@dennielsadian</nuxt-link>
          </span>
        </p>
      </div>
    </header>
      ...
      <div class="w3-content">
        ...
        >
          <input
            ...
            class="w3-input w3-hover-light-gray w3-light-white w3-col s10"
            placeholder="Search..."
            style="border:0px; padding:3px; margin:4.5px 0px 4.5px 0px;
          ...
          <button
            ...
            style="padding:3px; margin:4.5px 0px 4.5px 0px;
    ...
    >{% block content %}{% endblock %} {% include 'blog/archive.html' %}</div>
    {% include 'personal/contact_form.html' %}
    <Footer/>
  </div>
</template>
